...
(function () {
    ...
    function TestClientViewModel(data) {
        ...
        addOrReplaceHeader(self.RequestHeaders, "Authorization", String.empty)
        addOrReplaceHeader(self.RequestHeaders, "Accept", "application/json");
        self.RequestMediaType.subscribe(function () {
            ...
            //addOrReplaceHeader(headers, "Authorization", String.empty);
...
function addOrReplaceHeader(headers, headerName, headerValue) {
    ...
    for (var i in headerList) {
        if (headerList[i].name.toLowerCase() == headerName) {
            headers.replace(headerList[i], { name: headerList[i].name, value: headerValue, id: 'dfdf' });
            return;
        }
    }
    headers.push({ name: headerName, value: headerValue, id: 'dfdf' });
}
