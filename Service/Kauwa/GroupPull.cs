...
namespace TekTak.iLoop.Kauwa
{
  ...
  [Serializable]
  #endif
  public partial class GroupPull : TBase
  {
    ...
    public bool IncludeInstance
    {
      get
      {
        return _includeInstance;
      }
      set
      {
        __isset.includeInstance = true;
        this._includeInstance = value;
      }
    }
        ...
        switch (field.ID)
        {
          ...
          case 8:
            if (field.Type == TType.Bool) {
              IncludeInstance = iprot.ReadBool();
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("GroupPull");
      ...
      if (__isset.includeInstance) {
        field.Name = "includeInstance";
        field.Type = TType.Bool;
        field.ID = 8;
        oprot.WriteFieldBegin(field);
        oprot.WriteBool(IncludeInstance);
        oprot.WriteFieldEnd();
      }
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("GroupPull(");
      bool __first = true;
      if (UserId != null && __isset.userId) {
